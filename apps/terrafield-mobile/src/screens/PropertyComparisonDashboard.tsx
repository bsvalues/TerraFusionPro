        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowReconciledValueModal(false)}>
                <MaterialCommunityIcons name="close" size={24} color="#333" />
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowSavedResultsModal(false)}>
                <MaterialCommunityIcons name="close" size={24} color="#333" />
              </TouchableOpacity>
            </View>
            ...
            <ScrollView style={styles.modalScrollView}>
              ...
              <View style={styles.propertyDetailSection}>
                ...
                <View style={styles.propertyDetailItem}>
                  ...
                  <Text style={styles.propertyDetailValue}>{selectedProperty.propertyType}</Text>
                </View>
              </View>
              ...
              <View style={styles.propertyDetailSection}>
                ...
                <View style={styles.propertyDetailItem}>
                  ...
                  <Text style={styles.propertyDetailValue}>{selectedProperty.bedrooms}</Text>
                </View>

                <View style={styles.propertyDetailItem}>
                  <Text style={styles.propertyDetailLabel}>Bathrooms:</Text>
                  <Text style={styles.propertyDetailValue}>{selectedProperty.bathrooms}</Text>
                </View>
                ...
                <View style={styles.propertyDetailItem}>
                  ...
                  <Text style={styles.propertyDetailValue}>{selectedProperty.yearBuilt}</Text>
                </View>

                <View style={styles.propertyDetailItem}>
                  <Text style={styles.propertyDetailLabel}>Garage Spaces:</Text>
                  <Text style={styles.propertyDetailValue}>{selectedProperty.garageSpaces}</Text>
                </View>
              </View>
              ...
              <View style={styles.propertyDetailSection}>
                ...
                <View style={styles.propertyDetailItem}>
                  ...
                  <Text style={styles.propertyDetailValue}>{selectedProperty.condition}</Text>
                </View>

                <View style={styles.propertyDetailItem}>
                  <Text style={styles.propertyDetailLabel}>Quality:</Text>
                  <Text style={styles.propertyDetailValue}>{selectedProperty.quality}</Text>
                </View>

                <View style={styles.propertyDetailItem}>
                  <Text style={styles.propertyDetailLabel}>Days on Market:</Text>
                  <Text style={styles.propertyDetailValue}>{selectedProperty.daysOnMarket}</Text>
                </View>
              </View>
