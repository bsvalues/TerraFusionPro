        ...
        renderItem={({ item }) => (
          <View style={styles.changeItem}>
            <View style={styles.changeHeader}>
              ...
              <Text style={styles.changeTime}>{formatTimestamp(item.timestamp)}</Text>
            </View>
        ...
        >
          <View style={styles.commentModal}>
            <View style={styles.commentModalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowNewCommentModal(false)}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.commentDetailModal}>
            <View style={styles.commentModalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowCommentDetailModal(false)}>
                <MaterialCommunityIcons name="close" size={24} color="#333" />
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.changeHistoryModal}>
            <View style={styles.changeHistoryHeader}>
              ...
              <TouchableOpacity onPress={() => setShowChangeHistoryModal(false)}>
                <MaterialCommunityIcons name="close" size={24} color="#333" />
              </TouchableOpacity>
            </View>
