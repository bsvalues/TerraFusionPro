    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Autonomous AI-driven property intelligence with blockchain verification, 
          predictive modeling, and drone coordination
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-4 items-end">
                ...
                >
                  {loading.prediction && <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>}
                  Generate Prediction
                </Button>
              </div>
                ...
                <div className="mt-6 p-4 border rounded-lg space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Range: ${prediction.confidenceInterval.lower} - ${prediction.confidenceInterval.upper}
                      </p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground">Market Trend</p>
                      <p className={`text-2xl font-bold capitalize ${getTrendColor(prediction.trend)}`}>
                        {prediction.trend}
                      </p>
                    </div>
                    <div className="text-center">
        ...
        <TabsContent value="drones">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Deploy drones for property scanning and measurement
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4">
                <Button 
                  ...
                  className="flex items-center gap-2"
                >
                  {loading.drone && <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>}
            ...
            <CardContent className="space-y-4">
              <div className="p-4 border rounded-lg bg-muted/50">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  This creates a demonstration NFT with mock blockchain interaction. 
                  For production use, configure blockchain credentials.
                </p>
                <Button 
                  onClick={mintNFT} 
                  ...
                  className="flex items-center gap-2"
                >
                  {loading.nft && <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>}
                  Mint Demo NFT
                </Button>
              </div>
