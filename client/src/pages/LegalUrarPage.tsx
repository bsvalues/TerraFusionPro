          ...
          <div className="bg-white rounded-md border h-full overflow-auto flex flex-col">
            <div className="p-4 bg-muted border-b flex items-center justify-between">
              <div className="flex items-center">
                <Badge variant="outline" className="mr-2">Official URAR Form</Badge>
                <span className="text-sm text-muted-foreground">This form is compliant with all legal regulations</span>
              </div>
            ...
            <div className="flex-1 overflow-auto p-6">
              ...
              <div className="border border-dashed rounded-md p-12 h-full bg-white">
                <h2 className="text-2xl font-semibold text-center mb-8">Uniform Residential Appraisal Report</h2>
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-6">
                    ...
                    <div className="border-b pb-2">
                      ...
                      <div className="text-md">{formData.bedrooms} / {formData.bathrooms}</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="border-b pb-2">
                      ...
                      <div className="text-md">{new Date(formData.appraisalDate).toLocaleDateString()}</div>
                    </div>
                    ...
                    {aiInsights.condition && (
                      <div className="border-b pb-2">
                        ...
                        <div className="text-sm">
                          ...
                          <div className="text-sm">{aiInsights.condition.key_strengths.join(', ')}</div>
                          
                          {aiInsights.condition.key_concerns.length > 0 && (
                            <>
                              <div className="text-xs text-muted-foreground mt-1">Key concerns:</div>
                              <div className="text-sm">{aiInsights.condition.key_concerns.join(', ')}</div>
                            </>
                          )}
                        </div>
                      </div>
                ...
                <div className="mt-12 text-center text-sm text-muted-foreground">
                  This is a simulated URAR form for demonstration purposes. In a real implementation, this would be an official URAR form displayed in an iframe.
                </div>
              </div>
            </div>
          </div>
