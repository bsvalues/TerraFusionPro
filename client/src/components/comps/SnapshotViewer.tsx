...
import { History, ArrowLeftRight, ExternalLink, Share2, FileText } from "lucide-react";
          ...
          <TabsContent value="compare">
                ...
                {!compareSnapshot ? (
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <Button variant="ghost" size="sm" onClick={handleSwapSnapshots}>
            ...
            {selectedSnapshot && compareSnapshot && (
              <div className="mt-6 pt-6 border-t">
                ...
                <SnapshotDiff baseSnapshot={selectedSnapshot} compareSnapshot={compareSnapshot} />
              </div>
            )}
          </TabsContent>
        </Tabs>
