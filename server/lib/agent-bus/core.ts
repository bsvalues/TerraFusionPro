  ...
  private async mockAgentInvocation(agentId: string, data: any): Promise<any> {
    ...
    switch (agentId) {
      ...
      case "narrative-synth":
        return {
          narrative:
            "Property is in good condition with recent updates to kitchen and bathrooms. Comparable properties in the area show strong market activity.",
          confidence: 0.92,
          ...
          factors: [
            {
              ...
              impact: "positive",
              description: "Stable appreciation trend",
            },
