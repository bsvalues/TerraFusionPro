...
const uadRules: ComplianceRule[] = [
  ...
  },
  {
    ...
    message:
      "One or more comparable properties are missing a sales price. UAD requires sales prices for all comparables.",
...
const clientRules: ComplianceRule[] = [
  {
    ...
    check: async (_, __, comparables, adjustments) => {
      for (const comp of comparables) {
        ...
        const netAdjustment = compAdjustments.reduce((sum, adj) => sum + Number(adj.amount), 0);
    ...
    message:
      "Adjustment percentages exceed acceptable limits. Net adjustments should be within 15% and gross adjustments within 25%.",
    field: "adjustments",
  },
  {
    id: "CLIENT002",
  ...
  },
  {
    ...
    message:
      "One or more comparable properties are located more than 1 mile from the subject property.",
