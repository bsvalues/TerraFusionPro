    ...
    <PageLayout
      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          <Button onClick={handleGenerateAnalysis} disabled={marketAnalysisMutation.isPending}>
            <RefreshCw
          ...
          <TabsContent value="inventory">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Total active listings by month</CardDescription>
              </CardHeader>
              <CardContent className="h-[400px]">
                {marketAnalysisMutation.isPending ? (
          ...
          <TabsContent value="neighborhoods">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Market metrics across different neighborhoods</CardDescription>
              </CardHeader>
              <CardContent>
                {marketAnalysisMutation.isPending ? (
